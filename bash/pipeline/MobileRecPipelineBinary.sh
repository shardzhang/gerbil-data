...
# name: shard zhang
# date: 2026/7/1
# note: Encode features and generate TFRecord + Parquet training samples for MobileRec
...
day="20260701"
input_path=${MOBILE_REC_PATH}
output_path=${MOBILE_REC_OUTPUT_PATH}/train_sample/binary
...
--master 'local[*]' \
--class pipeline.mobilerec.MobileRecPipeline \
...
--train_ratio 0.8 \
--val_ratio 0.1 \
--feature_config ${PROJECT_HOME}/src/main/resources/mobilerec/binary_features.yaml \
--target_mode binary
) 2>&1 | tee "${log_file}"
