...
# name: shard zhang
# date: 2026/7/1
# note: Encode features and generate TFRecord + Parquet training samples for Ali_Display_Ad_Click
...
day="20260701"
input_path=${ALI_CTR_PATH}
output_path=${ALI_CTR_OUTPUT_PATH}/train_sample/binary
...
--train_ratio 0.8 \
--val_ratio 0.1 \
--feature_config ${PROJECT_HOME}/src/main/resources/alictr/binary_features.yaml \
--target_mode binary
) 2>&1 | tee "${log_file}"
