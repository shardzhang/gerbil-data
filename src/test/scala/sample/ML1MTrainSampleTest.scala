...
class ML1MTrainSampleTest extends WordSpec with Matchers {
  ...
  "ML1MTrainSample.parseSample" should {
    ...
    "parse context time fields" in {
      ...
      val (sample, _) = ML1MTrainSample.parseSample(row, movie_info)
